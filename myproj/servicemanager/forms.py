...
class TaskForm(forms.Form):
    Stations = ChoiceFieldNoValidation(label="Station", widget=forms.Select(attrs={"class":"form-control", "id":"ddlStation", "searchable":"Search here.."}))
    ...
    TotalIterations = forms.IntegerField(required=False, label="Total Iterations", widget = forms.NumberInput(attrs={"class":"form-control", "placeholder": "Please enter Iterations"}))
